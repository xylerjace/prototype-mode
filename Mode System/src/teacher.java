...
public class teacher {
	...
	private void initialize() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int menu =JOptionPane.showOptionDialog(frame.getContentPane(), "What do you want to do?", "Menu",
					...
					if (menu == 1) {
						...
						JOptionPane.showMessageDialog(null,"This page is used by the teachers and in this page \n they can post their tasks for the students " 
														+ "Input the task in the textfield and click post and set the deadline", 
		...
		textField.setBounds(49, 241, 364, 20);
		frame.getContentPane().add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setBounds(49, 272, 364, 20);
		frame.getContentPane().add(textField_1);
		textField_1.setColumns(10);
		
		textField_2 = new JTextField();
		textField_2.setBounds(49, 303, 364, 20);
		frame.getContentPane().add(textField_2);
		textField_2.setColumns(10);
		
		textField_3 = new JTextField();
		textField_3.setBounds(49, 334, 364, 20);
		frame.getContentPane().add(textField_3);
		textField_3.setColumns(10);
		
		textField_4 = new JTextField();
		textField_4.setBounds(49, 363, 364, 20);
		frame.getContentPane().add(textField_4);
		textField_4.setColumns(10);
		
		textField_5 = new JTextField();
		textField_5.setBounds(49, 394, 364, 20);
		frame.getContentPane().add(textField_5);
		textField_5.setColumns(10);
		
		textField_6 = new JTextField();
		textField_6.setBounds(49, 425, 364, 20);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				stud.txtGhj.setText(textField.getText());
		...
		JButton btnNewButton_6 = new JButton("POST");
		...
		JButton btnNewButton_7 = new JButton("POST");
		...
		JButton btnNewButton_8 = new JButton("POST");
